...
foreach $file (@files) #collecting the pass/warn/fail info for each lane.
{
	...
	if($file =~ /s_\d+_1_sequence.txt/)
	{
		#print the row (lane)
		print HTML "<tr><td><font size=2><a href=\"$firstpart"."_fastqc/fastqc_report.html\">$file</a></font></td><td nowrap>&nbsp;&nbsp;<font size=2>$samplenames[$j]</font>&nbsp;&nbsp;</td></td>$pfs</tr>\n";
	}
	else
	{
		print HTML "<tr><td><font size=2><a href=\"$firstpart"."_fastqc/fastqc_report.html\">$file</a></font></td><td nowrap>&nbsp;&nbsp;<font size=2>$samplenames[$j]</font>&nbsp;&nbsp;</td></td>$pfs</tr>\n";
...
foreach $file (@files)
{
	...
	{ 
		$thumb = "$firstpart"."_fastqc/Images/thumb.".$img_file;
		if(-e "fastqc/$thumb")
		{
	...
	if($file =~ /s_\d+_1_sequence.txt/)
	{
		print HTML2 "<tr><td><font size=2><a href=\"$firstpart"."_fastqc/fastqc_report.html\">$file</a></font></td><td nowrap>&nbsp;&nbsp;<font size=2>$samplenames[$j]</font>&nbsp;&nbsp;</td></td>$row</tr>\n";
	}
	else
	{
		print HTML2 "<tr><td><font size=2><a href=\"$firstpart"."_fastqc/fastqc_report.html\">$file</a></font></td><td nowrap>&nbsp;&nbsp;<font size=2>$samplenames[$j]</font>&nbsp;&nbsp;</td></td>$row</tr>\n";
